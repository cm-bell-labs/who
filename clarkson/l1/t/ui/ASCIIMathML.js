...
Version 1.4.2 Sep 19, 2004, (c) Peter Jipsen http://www.chapman.edu/~jipsen
...
var CONST = 0, UNARY = 1, BINARY = 2, INFIX = 3, LEFTBRACKET = 4, 
    RIGHTBRACKET = 5, SPACE = 6, UNDEROVER = 7, DEFINITION = 8, SPACER=9; // token types
...
{input:"Lim",  tag:"mo", output:"Lim", tex:null, ttype:UNDEROVER},
{input:"sin",  tag:"mo", output:"sin", tex:null, ttype:SPACER},
{input:"cos",  tag:"mo", output:"cos", tex:null, ttype:SPACER},
{input:"tan",  tag:"mo", output:"tan", tex:null, ttype:SPACER},
{input:"sinh", tag:"mo", output:"sinh", tex:null, ttype:SPACER},
{input:"cosh", tag:"mo", output:"cosh", tex:null, ttype:SPACER},
{input:"tanh", tag:"mo", output:"tanh", tex:null, ttype:SPACER},
{input:"cot",  tag:"mo", output:"cot", tex:null, ttype:SPACER},
{input:"sec",  tag:"mo", output:"sec", tex:null, ttype:SPACER},
{input:"csc",  tag:"mo", output:"csc", tex:null, ttype:SPACER},
{input:"log",  tag:"mo", output:"log", tex:null, ttype:SPACER},
{input:"ln",   tag:"mo", output:"ln",  tex:null, ttype:SPACER},
{input:"det",  tag:"mo", output:"det", tex:null, ttype:SPACER},
{input:"dim",  tag:"mo", output:"dim", tex:null, ttype:SPACER},
{input:"mod",  tag:"mo", output:"mod", tex:null, ttype:SPACER},
{input:"gcd",  tag:"mo", output:"gcd", tex:null, ttype:SPACER},
{input:"lcm",  tag:"mo", output:"lcm", tex:null, ttype:SPACER},
{input:"lub",  tag:"mo", output:"lub", tex:null, ttype:SPACER},
{input:"glb",  tag:"mo", output:"glb", tex:null, ttype:SPACER},
